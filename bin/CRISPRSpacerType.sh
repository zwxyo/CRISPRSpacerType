...
usage() {
    ...
    echo -e "  \033[1;32m--ccf\033[0m           Input CRISPRCasFinder json file format"
...
#================================================================================
# CRISPRCasFinder json
if [[ "$CCF_json" == true && "$CT" == true && "$ONLY_CT" == true ]]; then

  echo "Running CRISPRCasFinder json file processing..."

  # CRISPR
  python3 -c "import sys; sys.path.append('$python_module_dir'); from Json_process import batch_extract; batch_extract('${CSI}/ccf_result', '${result_summary}/result.csv')"
  python3 -c "import sys; sys.path.append('$python_module_dir'); from CRISPR_process import Data_filtering; Data_filtering('${result_summary}/result.csv', '${result_summary}/result_process.csv')"

  # CAS
  python3 -c "import sys; sys.path.append('$python_module_dir'); from Json_process import batch_extract_cas; batch_extract_cas('${CSI}/ccf_result', '${result_summary}/cas')"
  ...
  python3 -c "import sys; sys.path.append('$python_module_dir'); from CRISPR_classification import CRISPR_classification; CRISPR_classification('${result_summary}/result_process.csv', '${result_summary}/cas', '${result_summary}/CRISPR_sort', '${result_summary}/blast_result')"
  ...
  #--------------------------------------------------------------------------------
  # mlst
  output_mlst="$result_summary/mlst"
...
#================================================================================
elif [[ "$PCR_seq" == true && "$CT" == true ]]; then
