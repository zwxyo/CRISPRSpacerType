...
parser.add_argument('--min_len_rep', type=int, default=23,
                    help='min avg. length of the repeats (default: 23)')
...
parser.add_argument('--max_len_spacer', type=int, default=60,
                    help='max avg. length of spacers (default: 60)')
